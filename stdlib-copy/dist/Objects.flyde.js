...
exports.PropertyEquals = exports.DeleteAttribute = exports.SetAttribute = exports.GetAttribute = exports.ObjectAssign = exports.ObjectFromEntries = exports.ObjectEntries = exports.ObjectValues = exports.ObjectKeys = exports.JSONStringify = exports.JSONParse = void 0;
...
exports.ObjectAssign = {
    ...
    run: ({ target, sources }, { object }) => object.next(Object.assign(target, ...sources)),
};
exports.GetAttribute = {
    ...
    run: ({ object, attribute }, { value }) => value.next(attribute.split(".").reduce((obj, i) => obj[i], object)),
};
