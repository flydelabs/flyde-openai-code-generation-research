...
exports.SumList = exports.LessThanOrEqual = exports.LessThan = exports.GreaterThanOrEqual = exports.GreaterThan = exports.ToPrecision = exports.ToExponential = exports.ToFixed = exports.ParseFloat = exports.ParseInt = exports.Max = exports.Min = exports.Cos = exports.Sin = exports.Truncate = exports.Round = exports.Ceiling = exports.Floor = exports.AbsoluteValue = exports.SquareRoot = exports.Power = exports.Modulo = exports.Divide = exports.Multiply = exports.Subtract = exports.Add = void 0;
...
exports.ToExponential = {
    ...
    outputs: {
        exponential: {
            description: "The number with the specified number of decimal places in exponential notation",
        },
    },
    run: ({ number, places }, { exponential }) => exponential.next(number.toExponential(places)),
};
exports.ToPrecision = {
    id: "To Precision",
    namespace,
    ...
    run: ({ number, places }, { precision }) => precision.next(number.toPrecision(places)),
};
exports.GreaterThan = {
    id: "Greater Than",
    namespace,
